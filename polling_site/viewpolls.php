...
if ($conn->connect_error) {
    ...
    // select questionid, question, and total number of votes for each question
...
{
  echo "<tr><td align='center'><a href='voteonpoll.php?qid={$Value[0]}'>{$Value[1]}</td>"; // make a link to vote on a question and inserts questionid into link
